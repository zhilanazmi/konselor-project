...
@section('title', 'Detail Konseling Anak - KonselorKita')
...
<div class="card mb-4">
    <div class="card-body">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div>
                <h5 class="text-xl font-bold mb-1">{{ $student->full_name }}</h5>
                <p class="text-neutral-500 dark:text-neutral-400 mb-0 text-sm">NIS: {{ $student->nis }} &bull; Tahun Ajaran: {{ $counseling->academicYear->name }}</p>
            </div>
...
<div class="mt-4">
    <a href="{{ route('orang-tua.children.counselings', $student) }}" class="btn btn-outline-secondary flex items-center gap-2 w-fit">
