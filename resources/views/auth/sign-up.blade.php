...
@section('title', 'Sign Up - Konselor')
    ...
    <div class="lg:w-1/2 py-8 px-6 flex flex-col justify-center">
        <div class="lg:max-w-[464px] mx-auto w-full">
            <div>
                ...
                <p class="mb-8 text-secondary-light text-lg">Welcome! please enter your detail</p>
            </div>
            <form action="#">
                ...
                <div class="mt-8 text-center text-sm">
                    <p class="mb-0">Already have an account? <a href="{{ route('sign-in') }}" class="text-primary-600 font-semibold hover:underline">Sign In</a></p>
                </div>
