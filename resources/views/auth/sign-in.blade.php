...
@section('title', 'Sign In - Konselor')
        ...
        <div class="lg:max-w-[464px] mx-auto w-full">
            ...
            <form action="#">
                ...
                <div class="mt-8 text-center text-sm">
                    <p class="mb-0">Don't have an account? <a href="{{ route('sign-up') }}" class="text-primary-600 font-semibold hover:underline">Sign Up</a></p>
                </div>
