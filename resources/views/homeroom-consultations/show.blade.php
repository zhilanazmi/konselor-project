...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-700 flex flex-wrap gap-6 text-sm">
            ...
            <div class="flex items-center gap-2 text-neutral-500 dark:text-neutral-400">
                <iconify-icon icon="solar:buildings-bold" class="text-lg text-primary-600"></iconify-icon>
                <span>Wali Kelas: <strong class="text-neutral-700 dark:text-neutral-200">{{ $consultation->teacher->full_name }}</strong></span>
            </div>
        </div>
    </div>
</div>
