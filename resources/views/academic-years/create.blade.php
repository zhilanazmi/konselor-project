...
@section('title', 'Tambah Tahun Ajaran - KonselorKita')

@section('content')

<div class="card">
    <div class="card-header">
        <h6 class="text-lg font-semibold mb-0">Form Tahun Ajaran Baru</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.academic-years.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') !border-danger-600 @enderror" placeholder="Contoh: 2025/2026">
                    @error('name')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="date" id="start_date" name="start_date" value="{{ old('start_date') }}" class="form-control @error('start_date') !border-danger-600 @enderror">
                    @error('start_date')
                        <p class="text-danger-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="end_date" name="end_date" value="{{ old('end_date') }}" class="form-control @error('end_date') !border-danger-600 @enderror">
                    @error('end_date')
                        <p class="text-danger-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="form-check-input">
