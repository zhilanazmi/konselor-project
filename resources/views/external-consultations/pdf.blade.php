...
<head>
    <meta charset="UTF-8">
    <title>Laporan Konsultasi Pihak Luar</title>
    <style>
...
<div class="container">
    <div class="header">
        <h2>Laporan Konsultasi Pihak Luar</h2>
    ...
    <table class="info">
        ...
        <tr><td>Nama Pihak Luar</td><td>: {{ $consultation->external_party_name }}</td></tr>
        <tr><td>Peran / Hubungan</td><td>: {{ $consultation->external_party_role }}</td></tr>
        <tr><td>Siswa Terkait</td><td>: {{ $consultation->student?->full_name ?? '-' }}</td></tr>
