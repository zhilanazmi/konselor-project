...
@section('title', 'Riwayat Konseling Individual - KonselorKita')
...
<div class="card">
    <div class="card-header flex flex-wrap items-center justify-between gap-4">
        <div>
            <h6 class="text-lg font-semibold mb-1">Riwayat Konseling Individual</h6>
            <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-0">Daftar sesi konseling individual Anda bersama Guru BK.</p>
        </div>
    </div>
                ...
                <tbody>
                    @forelse($counselings as $index => $counseling)
                        <tr>
                            ...
                            <td>
                                <span class="font-medium">{{ $counseling->counselor->name }}</span>
                            </td>
                            ...
                            <td class="!text-center">
                                <a href="{{ route('siswa.counselings.show', $counseling) }}" class="w-8 h-8 bg-info-50 dark:bg-info-600/25 text-info-600 rounded-lg flex items-center justify-center hover:bg-info-100 mx-auto" title="Detail">
                        ...
                        <tr>
                            <td colspan="7" class="!text-center py-8">
                                <div class="flex flex-col items-center gap-2 text-neutral-400">
                                    ...
                                    <p class="mb-0">Belum ada riwayat konseling individual.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
