...
@section('title', 'Detail Konseling - KonselorKita')
...
<div class="card mb-4">
    <div class="card-body">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div>
                <h5 class="text-xl font-bold mb-1">Detail Sesi Konseling</h5>
...
<div class="mt-4">
    <a href="{{ route('siswa.counselings.index') }}" class="btn btn-outline-secondary flex items-center gap-2 w-fit">
